...
class SettingScreen(Screen):
    ...
    def create(self):
        ...
        setting_label_1.set_text("Unicom")
        ...
        setting_btn_11_label.set_text("Params")
        ...
        setting_btn_11_label.set_style_text_font(lv.font_montserrat_16, lv.STATE.DEFAULT)
        ...
        setting_btn_12_label.set_text("Basic")
        ...
        setting_btn_12_label.set_style_text_font(lv.font_montserrat_16, lv.STATE.DEFAULT)
        ...
        setting_label_16.set_text("Soil")
        ...
        setting_label_22.set_text("Light")
        ...
        setting_btn_1_label.set_text("Save")
        ...
        setting_btn_1_label.set_style_text_font(lv.font_montserrat_14, lv.STATE.DEFAULT)
