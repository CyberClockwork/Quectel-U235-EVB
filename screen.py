...
class Screen(object):
    ...
    def create_style(self):
        ...
        style_list_btn_label.set_text_font(lv.font_montserrat_16)
        ...
        style_siyuan_12.set_text_font(lv.font_montserrat_14)
        ...
        style_siyuan_18.set_text_font(lv.font_montserrat_16)
        ...
        style_siyuan_20.set_text_font(lv.font_montserrat_16)
        ...
        style_siyuan_26.set_text_font(lv.font_montserrat_16)
        ...
        style_siyuan_22.set_text_font(lv.font_montserrat_16)
        ...
        style_ta.set_text_font(lv.font_montserrat_14)
